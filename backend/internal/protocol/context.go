...
func (p Protocol) newContext(w http.ResponseWriter, r *http.Request) *httpContext {
	...
	go func() {
		...
		if (errors.Is(cause, tusdS3Handler.ErrServerShutdown) || errors.Is(cause, tusdS3Handler.ErrUploadInterrupted) || errors.Is(cause, tusdS3Handler.ErrUploadStoppedByServer)) && ctx.body != nil {
...
func (p Protocol) getContext(w http.ResponseWriter, r *http.Request) *httpContext {
